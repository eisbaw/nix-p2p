        ...
        match self {
            ...
            SharingProfile::LanShare => {
                "lan-share: serve + announce to same-scope LAN peers on a provably-private listen; \
                 egress + serving are LAN-confined (dial veto, serve provenance, distinct \
                 lan-share.v1 scope — TASK-280)"
            }
...
impl OperatorContract {
    ...
    pub fn preflight(&self) -> String {
        ...
        // of truth. This surfaces the frozen CEILING (path + hash + the FULL declared budget:
        // upload/RAM/disk/fd/discovery/announce); the "effective resource controls" block above shows
